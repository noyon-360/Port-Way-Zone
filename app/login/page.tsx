      ...
      >
        <div className="glass-card rounded-3xl p-8 sm:p-10 relative overflow-hidden">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-slate-400">Sign in to access your Portway workspace</p>
          </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between ml-1">
                <label className="text-xs font-semibold tracking-wide text-slate-300 uppercase">Password</label>
          ...
          <div className="mt-8 pt-8 border-t border-white/5 text-center">
            <p className="text-sm text-slate-400">
              New to Portway?{" "}
              <Link href="/register" className="text-white hover:text-primary-400 font-medium transition-colors">
                Create an account
              </Link>
            </p>
          </div>
